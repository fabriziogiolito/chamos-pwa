...
import { loginWithEmail, loginWithGoogle, AuthError } from '@/lib/auth';
...
export default function SignIn() {
  ...
  const handleEmailSignIn = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if ('code' in result) {
        ...
        // Successful login - redirect will be handled by ProtectedRoute
        setLoading(false);
      }
    } catch (err) {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      if ('code' in result) {
        // This is an error
        setError((result as AuthError).message);
        setLoading(false);
      } else {
        // Successful login - redirect will be handled by ProtectedRoute
        setLoading(false);
